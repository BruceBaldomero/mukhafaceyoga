(function () {
  const T = {
    en: {
      ...
      'testimonials.score': '5.0 · 6 reviews',
      ...
      'contact.policies': 'Once your Fresha booking and health intake form are complete, Mona will review and confirm your appointment — a 30 deposit will then be requested to secure your spot. Please read our <a href="policies.html">Client Policies &amp; Disclaimer</a> before booking.',
    ...
    fr: {
      ...
      'contact.policies': 'Une fois votre réservation Fresha et votre formulaire de santé complétés, Mona confirmera votre rendez-vous — un acompte de 30 vous sera demandé pour sécuriser votre place. Veuillez lire nos <a href="policies.html">Politiques Clients &amp; Mentions légales</a> avant de réserver.',
    ...
    tl: {
      ...
      'testimonials.score': '5.0 · 6 pagsusuri',
      ...
      'contact.policies': 'Kapag nakumpleto na ang inyong booking sa Fresha at health intake form, susuriin at kukumpirmahin ni Mona ang inyong appointment — ang isang deposito na 30 ay hihilingin upang masiguro ang inyong lugar. Pakibasa ang aming <a href="policies.html">Mga Patakaran para sa Kliyente &amp; Disclaimer</a> bago mag-book.',
      ...
      'service.monthly.note': 'Kinakailangan ng minimum na 3-buwang pangako. Kailangan ng direct debit setup. Mga add-on available para sa 20 bawat isa.',
